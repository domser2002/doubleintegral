...
% n(optional) - number of subintervals for variable x, by default 10,
% m(optional) - number of subintervals for variable y, by default n^2.
% Function f must be specified in every point of D.
